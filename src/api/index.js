...
class api {
  ...
  static delete_Student = (id) => axios.delete(conexion.urlLocal + `contacts/${id}`, id, conexion.headers)
  static create_Student = (params) => axios.post(conexion.urlLocal + `contacts`, params, conexion.headers)
  static  update_student = (params) => 
    axios.post(conexion.urlLocal+ `contacts/${id}`, params, { headers: conexion.headers })
}
